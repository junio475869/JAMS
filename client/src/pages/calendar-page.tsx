...
import { AlertCircle, Calendar as CalendarIcon, ChevronLeft, ChevronRight, Clock, ExternalLink, Mail, Plus, Search, Share2, Video, Building, Link } from "lucide-react";
import { DateRange } from "react-day-picker";
import { addDays, addHours, eachDayOfInterval, eachHourOfInterval, format, getDay, getHours, isSameDay, isWeekend, parse, set, setHours, startOfMonth, startOfWeek, endOfWeek, subDays, addWeeks, addMonths, getWeek } from "date-fns";
...
export default function CalendarPage() {
  ...
  const [calendarSources, setCalendarSources] = useState<CalendarSource[]>([
    ...
    { id: "personal", name: "Personal Calendar", color: "#8b5cf6", enabled: false },
  ]);
      ...
      const mockEvents: CalendarEvent[] = [
        {
          ...
          date: new Date(currentYear, currentMonth, currentDate.getDate() + 3, 14, 0),
          type: "interview",
          notes: "Technical interview for Software Engineer position. Focus on algorithms and system design.",
          company: "Acme Inc",
          jobUrl: "https://example.com/jobs/software-engineer",
          companyOverview: "Acme Inc is a leading technology company specializing in cloud infrastructure and services with over 5,000 employees worldwide.",
        ...
        },
        {
          ...
          date: new Date(currentYear, currentMonth, currentDate.getDate() + 5, 11, 0),
          type: "interview",
          notes: "HR interview to discuss compensation and benefits.",
          company: "Globex Corporation",
          jobUrl: "https://example.com/jobs/senior-developer",
          companyOverview: "Globex Corporation is a multinational technology firm focused on innovative software solutions and digital transformation.",
        ...
        },
        {
          ...
          date: new Date(currentYear, currentMonth, currentDate.getDate() + 2, 15, 30),
          type: "followup",
        ...
        },
        {
          ...
          date: new Date(currentYear, currentMonth, currentDate.getDate() + 8, 23, 59),
          type: "deadline",
          ...
          companyOverview: "Umbrella Corporation is a pharmaceutical company known for cutting-edge research and development in biotechnology."
        },
        {
          id: "5",
          title: "Resume Review Session",
          date: new Date(currentYear, currentMonth, currentDate.getDate() + 1, 13, 0),
          type: "other",
        ...
        },
        {
          ...
          date: new Date(currentYear, currentMonth, currentDate.getDate() + 4, 10, 0),
          type: "interview",
          notes: "Complete coding assessment for Senior Full Stack position.",
          company: "Wayne Enterprises",
          jobUrl: "https://example.com/jobs/senior-fullstack-wayne",
          companyOverview: "Wayne Enterprises is a global technology conglomerate with interests in software, hardware, and digital services.",
        ...
        },
        {
          ...
          date: new Date(currentYear, currentMonth, currentDate.getDate() + 6, 14, 30),
          type: "interview",
          notes: "Panel interview with engineering team for Machine Learning Engineer role.",
          company: "Cyberdyne Systems",
          jobUrl: "https://example.com/jobs/ml-engineer-cyberdyne",
          companyOverview: "Cyberdyne Systems is a pioneer in AI and machine learning technologies with a focus on autonomous systems.",
  ...
  const getEventBadgeColor = (type: string) => {
    switch (type) {
      ...
      case "followup": return "bg-purple-500 hover:bg-purple-600";
    ...
    <div className="container py-10">
      {isDemoMode && (
        <div className="bg-blue-900/30 border border-blue-700 rounded-lg p-4 mb-6">
          <p className="text-blue-300 font-medium">
            You're in demo mode. Calendar features are limited with sample data only.
          </p>
        </div>
      )}
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => toast({ 
          ...
          description: "Connect Google Calendar to enable calendar sync functionality." 
        })}>
          ...
          <div className="mb-6 flex flex-wrap justify-between items-center">
            <div className="flex items-center space-x-2 mb-2 sm:mb-0">
              <Button 
                variant="outline" 
                size="sm" 
                onClick={() => setDate(prev => prev ? subDays(prev, calendarViewType === "monthly" ? 30 : calendarViewType === "weekly" ? 7 : 1) : new Date())}
              >
              ...
              <Button 
                variant="outline" 
                size="sm" 
                onClick={() => setDate(prev => prev ? addDays(prev, calendarViewType === "monthly" ? 30 : calendarViewType === "weekly" ? 7 : 1) : new Date())}
              >
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.value) {
                      toast({
                        ...
                        description: "This would search through your calendar events"
                      });
                    }
                  }}
                />
              ...
              {calendarViewType === "monthly" && (
                <div>
                  <Calendar
                    ...
                    className="w-full"
                    modifiers={{
                      event: (date) => events.some(event => isSameDay(date, event.date)),
                      weekend: isWeekend
                    }}
                    modifiersClassNames={{
                ...
                <div>
                  <div className="grid grid-cols-7 gap-1">
                    {getWeeklyViewData().map((day, index) => (
                      <div key={index} className={`min-h-60 border rounded-md ${isSameDay(day.date, new Date()) ? 'bg-primary/5 border-primary' : isWeekend(day.date) ? 'bg-muted/30' : ''}`}>
                        <div className="p-2 text-center border-b sticky top-0 bg-card">
                          <div className="font-medium">{format(day.date, "EEE")}</div>
                          <div className={`text-2xl ${isSameDay(day.date, new Date()) ? 'font-bold text-primary' : ''}`}>
                            {format(day.date, "d")}
                          </div>
                        </div>
                        <div className="p-1">
                              ...
                              {day.events
                                ...
                                .map(event => (
                                  ...
                                  >
                                    ...
                                    <div className="text-muted-foreground">{format(event.date, "h:mm a")}</div>
                                  </button>
                                ))
                              }
                            </div>
                    ...
                    {getDailyViewData().map((hourSlot, index) => (
                      <div 
                        ...
                        className={`flex border-b last:border-b-0 ${
                          hourSlot.hour === getHours(new Date()) ? 'bg-primary/5' : ''
                        }`}
                      >
                  ...
                  <div className="min-w-[800px]">
                    <div className="grid grid-cols-[100px_minmax(0,1fr)] border rounded-md">
                      <div className="border-r">
                        ...
                        <div className="p-2 h-12 border-b font-medium">All Day</div>
                        {Array.from({ length: 12 }).map((_, i) => (
                          <div key={i} className="p-2 h-12 border-b text-sm text-muted-foreground">
                        ...
                        {getTimelineViewData().map((day, dayIndex) => (
                          <div key={dayIndex} className={`border-r last:border-r-0 ${day.isWeekend ? 'bg-muted/30' : ''} ${day.isToday ? 'bg-primary/5' : ''}`}>
                            <div className="h-12 border-b p-2 text-center sticky top-0 bg-card">
                              <div className="font-medium">{format(day.date, "EEE")}</div>
                              <div className={day.isToday ? 'font-bold text-primary' : ''}>
                            ...
                            <div className="p-1 h-12 border-b">
                              {day.events
                                .filter(event => getHours(event.date) === 0 || event.type === "deadline")
                                .map((event, i) => (
                                  <button
                                    key={`${event.id}-${i}`}
                ...
                <CardContent>
                  {upcomingEvents.length > 0 ? (
                        ...
                        >
                          ...
                          {event.company && (
                            <div className="text-sm mt-2">
                              <span className="text-muted-foreground">Company:</span> {event.company}
                            </div>
                          )}
                          {event.location && (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-muted-foreground">You don't have any events scheduled for the next 7 days.</p>
                    </div>
                  )}
                </CardContent>
                <CardFooter>
            ...
            <div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Event types and their colors</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="md:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Select a date range to generate availability text</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="mb-6">
                  <Calendar
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select defaultValue="default">
                      ...
                      <SelectContent>
                        <SelectItem value="default">Standard work hours (9am-5pm)</SelectItem>
                        <SelectItem value="morning">Morning only (9am-12pm)</SelectItem>
                        <SelectItem value="afternoon">Afternoon only (1pm-5pm)</SelectItem>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Copy and paste into emails or messages</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-muted rounded-md p-4 min-h-40">
                  <pre className="whitespace-pre-wrap text-sm">
                    {generateAvailabilityText() || "Select a date range to generate availability text"}
                  </pre>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                <Button variant="outline" onClick={() => toast({
                  ...
                  description: "You can now paste it into your email or message"
                })}>Copy Text</Button>
                <Button onClick={() => toast({
                  title: "Sharing not available in demo",
                  description: "This would generate a shareable link with your availability"
                })}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardFooter>
                <Button variant="outline" className="w-full" onClick={() => toast({
                  title: "Not available in demo mode",
                  description: "This would allow connecting to Google, Outlook, or other calendar services"
                })}>
                  <Plus className="h-4 w-4 mr-2" />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage calendar notifications and reminders</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card className="md:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Import and export calendar data</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="rounded-md border border-amber-200 bg-amber-50 p-4 text-amber-800 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-400">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="font-medium">Google Calendar integration is disabled in demo mode</div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  {selectedEvent.companyOverview && (
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{selectedEvent.companyOverview}</p>
                    </div>
                  )}
                </div>
                  ...
                  {selectedEvent.contactEmail && (
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a href={`mailto:${selectedEvent.contactEmail}`} className="text-sm text-blue-500 hover:underline">
                          {selectedEvent.contactEmail}
                        </a>
                      </div>
                    </div>
                  ...
                  {selectedEvent.interviewLink && (
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a href={selectedEvent.interviewLink} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">
                          Join Meeting
                        </a>
                      </div>
                    </div>
                  ...
                  {selectedEvent.jobUrl && (
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a href={selectedEvent.jobUrl} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">
                          View Job Posting
                        </a>
                      </div>
                    </div>
              ...
              <DialogFooter className="flex justify-between items-center gap-2">
                <div>
                  <Button variant="outline" size="sm" onClick={() => toast({
                    title: "Not available in demo mode",
                    description: "This would add the event to your calendar"
                  })}>
                ...
                <div className="flex gap-2">
                  ...
                  <Button onClick={() => {
                    toast({
                      ...
                      description: "A new email to the contact has been prepared"
                    });
